      ...
      colors: {
        ...
        triage: {
          green: {
            ...
            bg: "hsl(var(--triage-green-bg))",
            foreground: "hsl(var(--triage-green-foreground))",
          },
          amber: {
            DEFAULT: "hsl(var(--triage-amber))",
            bg: "hsl(var(--triage-amber-bg))",
            foreground: "hsl(var(--triage-amber-foreground))",
          },
          red: {
            DEFAULT: "hsl(var(--triage-red))",
            bg: "hsl(var(--triage-red-bg))",
        ...
        chart: {
          ...
          activity: "hsl(var(--chart-activity))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
