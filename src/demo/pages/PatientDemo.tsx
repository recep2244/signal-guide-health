...
const MEDICAL_FREETEXT_RESPONSES: { keywords: string[]; response: string; options?: string[] }[] = [
  ...
  {
    keywords: ['international', 'abroad', 'travel abroad', 'overseas', 'country', 'europe', 'america', 'usa', 'australia', 'global'],
    response: `**CardioWatch supports your care wherever you are.**\n\nOur platform is designed for international cardiac patients and those who travel:\n\n**If you're travelling abroad:**\n• Your CardioWatch monitoring continues via your Apple Watch and smartphone\n• Your wearable data is synced to your UK care team in real-time\n• Alert thresholds remain active — ${CLINICIAN_NAME}'s team will be notified of any concerns\n• Carry a copy of your medication list and recent clinical summary\n\n**International healthcare access:**\n• **European Health Insurance Card (EHIC/GHIC)** covers emergency care in Europe\n• **Travel insurance** — always declare your cardiac history; ensure cardiac cover is included\n• **Emergency numbers** vary by country — save local emergency numbers before you travel\n• **Medication supplies** — carry enough for your trip plus extra in case of delays\n\n**CardioWatch is expanding internationally:**\n• Currently live in the **UK NHS** with UKCA marking and NICE alignment\n• **EU expansion** planned with CE marking under MDR 2017/745\n• **US market** entry via FDA 510(k) and CMS RPM reimbursement pathway\n• **Australia, Gulf States, and Asia-Pacific** on our global roadmap\n\nWould you like help preparing for travel or understanding your international cover?`,
    options: ["I'm planning to travel", "Emergency contacts abroad", "Medication for travelling", "Is CardioWatch available overseas?"],
  },
  {
